...
class Form_Update_Khohang extends Zend_Form{
    ...
    public function createForm($id_kho)
    {
        ...
        $tenkhohang->setAttrib('class', 'formEdit')->setValue($khohang['TenKho']);
        $diachi->setAttrib('class', 'formEdit')->setValue($khohang['Diachi']);
        $sdt->setAttrib('class', 'formEdit')->setValue($khohang['sdt']);
        $loaikho->setAttrib('class', 'formEdit')->setValue($khohang['MaLoaiKho']);
