<?php
    ...
    if($hopdongall)
    {
        ...
        {            
            ...
            $button= "<a class ='thembutton' href='".HOST_PROJECT."/index/xem/hopdong/true/nhapsoi/true/mahopdong/".$hopdong['MaHopDong']."'/>Nhập Kho</a>";
            $chinhsua = '<a href="'.HOST_PROJECT."/index/xem/hopdong/true/chinhsua/true/mahopdong/".$hopdong['MaHopDong'].'">Sửa</a>&nbsp|&nbsp'.'<a href="'.HOST_PROJECT."/index/xem/hopdong/true/xoa/true/mahopdong/".$hopdong['MaHopDong'].'" onclick="return confirm('."'bạn có chắc muốn xóa ?'".')">Xóa</a>';
            $nhapkho = "";
