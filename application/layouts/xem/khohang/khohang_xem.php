    ...
    if($khohangall)
    {
        ...
        foreach ($khohangall as $khohang)
        {
            ...
            $content = array(
                ...
                '<a href="'.HOST_PROJECT."/index/xem/khohang/true/chinhsua/true/makho/".$khohang['MaKho']."/mactp/".$this->param->getParam("mactp").'"/">Sửa</a>&nbsp|&nbsp'.'<a href="'.HOST_PROJECT."/index/xem/khohang/true/xoa/true/makho/".$khohang['MaKho'].'" onclick="return confirm('."'bạn có chắc muốn xóa ?'".')">Xóa</a>',
            );
            $maincontent[]=$content;
